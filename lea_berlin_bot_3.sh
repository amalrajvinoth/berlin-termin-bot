...
LEA_VISA_CATEGORY="Aufenthaltstitel in einen neuen Pass übertragen" \
LEA_VISA_SUB_CATEGORY="" \
LEA_VISA_TYPE="Übertragen einer Aufenthaltserlaubnis auf einen neuen Pass(PASS)" \
